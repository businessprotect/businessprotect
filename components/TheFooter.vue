    ...
    <div class="container">
      <div class="footer-columns">
        ...
        <ul class="footer-links">
          ...
          <li>
            <a target="_blank" rel="noopener" href="https://www.facebook.com/npc.business.protect/" class="facebook-icon">
          ...
          <li>
            <a target="_blank" rel="noopener" href="" class="google-plus-icon">
              <svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
          ...
          <li>
            <a target="_blank" rel="noopener" href="" class="linkedin-icon">
              <svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="footer-links">
          <li>
            <h2>Business Protect</h2>
          </li>
            <li>Cu experiență în domeniu de peste 15 ani, NPC Business Protect se străduiește să exceleze pentru toți clienții în fiecare situație.</li>
        </ul>
      </div>
    </div>
