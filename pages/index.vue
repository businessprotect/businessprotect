  ...
  <section class="main">
    <div class="container">
      ...
      <article class="content">
        <div class="editable">
          <p>
            Suntem o echipă formată din oameni tineri, dinamici, ce lucrează în domeniile SSM-SU de peste
          ...
          <p>
            Suntem o echipă ce oferă un preț corect, în concordanță cu calitatea serviciilor prestate.
          </p>
        </div>
      </article>
    </div>
